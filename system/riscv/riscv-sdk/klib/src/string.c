...
void
WORDCOPY_FWD_ALIGNED (long int dstp, long int srcp, size_t n)
{
  op_t a0, a1;
...
void
WORDCOPY_FWD_DEST_ALIGNED (long int dstp, long int srcp, size_t n)
{
  op_t a0, a1, a2, a3;
  int sh_1, sh_2;
...
void
WORDCOPY_BWD_ALIGNED (long int dstp, long int srcp, size_t n)
{
  op_t a0, a1;
...
void
WORDCOPY_BWD_DEST_ALIGNED (long int dstp, long int srcp, size_t n)
{
  op_t a0, a1, a2, a3;
  int sh_1, sh_2;
...
size_t strlen(const char *s) {
  ...
  /* Handle the first few characters by reading one character at a time.
     Do this until CHAR_PTR is aligned on a longword boundary.  */
  for (char_ptr = s; ((unsigned long int) char_ptr & (sizeof (longword) - 1)) != 0; ++char_ptr)
    if (*char_ptr == '\0')
      return char_ptr - s;
